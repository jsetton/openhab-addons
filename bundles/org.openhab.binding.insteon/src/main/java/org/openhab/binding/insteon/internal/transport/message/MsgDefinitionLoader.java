...
/**
 * The {@link MsgDefinitionLoader} represents message definition loader
 *
 ...
 */
@NonNullByDefault
public class MsgDefinitionLoader extends ResourceLoader {
    private static final MsgDefinitionLoader MSG_DEFINITION_LOADER = new MsgDefinitionLoader();
    ...
    /**
     * Initializes message definition loader
     */
    @Override
    ...
    public static synchronized MsgDefinitionLoader instance() {
        if (MSG_DEFINITION_LOADER.getDefinitions().isEmpty()) {
            MSG_DEFINITION_LOADER.initialize();
        }
        return MSG_DEFINITION_LOADER;
    }
}
