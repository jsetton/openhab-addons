...
/**
 * The {@link ProductDataLoader} represents product data loader
 *
 * @author Jeremy Setton - Initial contribution
 */
@NonNullByDefault
public class ProductDataLoader extends ResourceLoader {
    private static final ProductDataLoader PRODUCT_DATA_LOADER = new ProductDataLoader();
    ...
    /**
     * Initializes product data loader
     */
    @Override
    ...
    public static synchronized ProductDataLoader instance() {
        if (PRODUCT_DATA_LOADER.getProducts().isEmpty()) {
            PRODUCT_DATA_LOADER.initialize();
        }
