...
public class LinkDBRecord extends DatabaseRecord {
    ...
    /**
     * Factory method for creating a new LinkDBRecord from another isntance with new location
     *
    ...
    /**
     * Factory method for creating a new LinkDBRecord from another isntance with new type
     *
     * @param type the new record type to use
     * @param record the link db record to use
     * @return the link db record with new type
     */
    public static LinkDBRecord withNewType(RecordType type, LinkDBRecord record) {
