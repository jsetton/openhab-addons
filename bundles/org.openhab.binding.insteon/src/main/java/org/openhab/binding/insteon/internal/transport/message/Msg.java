...
public class Msg {
    ...
    public static @Nullable Msg createMessage(byte[] buf, int msgLen, boolean isExtended) {
        ...
        return Optional.ofNullable(MsgDefinitionLoader.instance().getTemplate(buf[1], isExtended, Direction.FROM_MODEM))
    ...
    public static int getHeaderLength(byte cmd) {
        return Optional.ofNullable(MsgDefinitionLoader.instance().getTemplate(cmd, Direction.FROM_MODEM))
    ...
    public static int getMessageLength(byte cmd, boolean isExtended) {
        return Optional.ofNullable(MsgDefinitionLoader.instance().getTemplate(cmd, isExtended, Direction.FROM_MODEM))
    ...
    public static Msg makeMessage(byte cmd) throws InvalidMessageTypeException {
        return Optional.ofNullable(MsgDefinitionLoader.instance().getTemplate(cmd, Direction.TO_MODEM)).map(Msg::new)
                .orElseThrow(() -> new InvalidMessageTypeException(
    ...
    public static Msg makeMessage(String type) throws InvalidMessageTypeException {
        return Optional.ofNullable(MsgDefinitionLoader.instance().getTemplate(type)).map(Msg::new)
